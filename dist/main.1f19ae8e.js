...
window.dom = {
  // 实现查找和设置元素
  find: function find(tagName) {
    // 记得return 总是忘记return一个结果造成报错
    if (arguments.length === 1) {
      return document.querySelectorAll(tagName);
    }
  },
  style: function style(tagName, _style, color) {
    return tagName.style.color = color;
  },
  each: function each(divList, n) {
    var a = [];
...
var find1 = dom.find("#test>.red")[0];
var style2 = dom.style(test, "style", "red");
var divList = dom.find('.red');
var each1 = dom.each(divList, function (n) {
